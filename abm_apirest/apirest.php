...
$app->post("/registro/", function() use($app, $db)
{
	...
	// Preparamos la consulta a la tabla.
	// En PDO los parámetros para las consultas se pasan con :param1
	$consulta = $db->prepare("insert into persona (nombre,apellido) values (:param1, :param2, :param3)");
...
$app->put("/registro/", function() use($app, $db)
{
	...
	// Preparamos la consulta a la tabla.
	// En PDO los parámetros para las consultas se pasan con :param1
    $consulta = $db->prepare("update tabla set valor_char=:param1, valor_date=:param2, valor_int=:param3 where id=:id");
